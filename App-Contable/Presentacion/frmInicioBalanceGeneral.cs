...
{
    public partial class frmInicioBalanceGeneral : Form
    {
        private readonly LibroDiarioStorageService _storageService = new();

        public frmInicioBalanceGeneral()
        {
            InitializeComponent();
        ...
        private void ConfigurarFormulario()
        {
            ...
            // Eventos de botones
            btnGenerarBalance.Click += (s, e) => AbrirBalanceSeleccionado();
            ...
            lstLibros.DoubleClick += (s, e) => AbrirBalanceSeleccionado();
        ...
        public void RefrescarListaLibros()
        {
            ...
            if (!libros.Any())
            {
                lstLibros.Items.Add(new LibroDiarioListItem
                {
                    ...
                    Subtitulo = "Crea o registra un libro diario en el módulo de Libro Diario para generar su balance general."
                });
                lstLibros.EndUpdate();
                return;
            }
        ...
        private void AbrirBalanceSeleccionado()
        {
            var libro = ObtenerLibroSeleccionado();
            if (libro == null)
            {
                MessageBox.Show(
                    "Por favor, selecciona un libro diario de la lista para generar su balance general.",
                    "Selección Requerida",
            ...
            NavegacionHelper.NavegarA(this, new frmBalanceGeneral(libro));
        }
        ...
        private void MostrarVistaPrevia()
        {
            ...
            string mensaje = $"═══════════════════════════════════════\n" +
                             ...
                             $"¿Deseas abrir el balance general de este libro?";
