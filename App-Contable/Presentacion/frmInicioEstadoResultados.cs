...
{
    public partial class frmInicioEstadoResultados : Form
    {
        private readonly LibroDiarioStorageService _storageService = new();

        public frmInicioEstadoResultados()
        {
            InitializeComponent();
        ...
        private void ConfigurarFormulario()
        {
            ...
            // Eventos de botones
            btnGenerarEstadoResultados.Click += (s, e) => AbrirEstadoResultadosSeleccionado();
            ...
            lstLibros.DoubleClick += (s, e) => AbrirEstadoResultadosSeleccionado();
        ...
        public void RefrescarListaLibros()
        {
            ...
            if (!libros.Any())
            {
                lstLibros.Items.Add(new LibroDiarioListItem
                {
                    ...
                    Subtitulo = "Crea o registra un libro diario en el módulo de Libro Diario para generar su estado de resultados."
                });
                lstLibros.EndUpdate();
                return;
            }
        ...
        private void AbrirEstadoResultadosSeleccionado()
        {
            var libro = ObtenerLibroSeleccionado();
            if (libro == null)
            {
                MessageBox.Show(
                    "Por favor, selecciona un libro diario de la lista para generar su estado de resultados.",
                    "Selección Requerida",
            ...
            NavegacionHelper.NavegarA(this, new frmEstadoResultados(libro));
        }
        ...
        private void MostrarVistaPrevia()
        {
            ...
            string mensaje = $"═══════════════════════════════════════\n" +
                             ...
                             $"¿Deseas abrir el estado de resultados de este libro?";
            ...
            {
                AbrirEstadoResultadosSeleccionado();
            }
        }
    }
}
